 ...
 */
@Component({
	selector: 'static-table-link',
	templateUrl: './table-static-link.component.html',
	styleUrls: ['./table-static-link.component.scss']
})
export class StaticTableLinkComponent
{
    /**
	...
	/**
	 * The array of strings that indicates the variable of the queryParam, the value will be the input `value` 
	 */
	@Input()
	queryparamVariable: string[];
	...
	public constructor()
	{
		...
		this.queryparamVariable = [];
	}

	queryParams(pos, item){
		let param = {};
		param[this.queryparamVariable[pos]] = item;
		return param;
	}
}
