 ...
 */
export class ContainerPanelComponent extends ContainerControl {
    constructor() {
        super();
    }
    /**
...
/** @nocollapse */
ContainerPanelComponent.ctorParameters = () => [];
